            ...
            <div class="space-y-2">
                ...
                <div class="date-input-group space-x-4">
                    ...
                    <div class="relative w-56">
                        ...
                        <svg class="absolute left-2.0 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-500 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
