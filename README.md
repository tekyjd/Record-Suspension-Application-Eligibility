...
<body>
    ...
    <div id="app" class="container-card p-6 md:p-10">
        ...
        <section class="mb-8 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-lg">
            ...
            <p class="text-sm text-blue-600 mb-4">Eligibility results are for informational purposes only. They are provided in good faith, based solely on the information you enter. This tool does not provide legal advice, and the results do not guarantee eligibility or the approval or denial of a record suspension by the Parole Board of Canada.</p>
